...
driver.find_element(By.XPATH,
                    "//body/div[@id='__next']/div[1]/div[2]/div[1]/div[1]/div[2]/div[1]/button[1]/span[1]/span[1]/*[1]").click()
...
print('Price of max Product: ', driver.find_element(By.XPATH,
                                                    "/html[1]/body[1]/div[1]/div[1]/div[3]/div[1]/div[1]/div[1]/div[1]/div[2]/div[4]/h2[1]").text)
# PRODUCT WORK DONE

driver.find_element(By.XPATH,
                    "//button[contains(text(),'I understand')]").click()  # have to click this 1st before career
